    ...
    >
      ...
      >
        ...
        <div
          className={`w-[260px] ${
            isSticky && "-mb-2"
          } cursor-pointer flex items-center justify-between px-5 h-[50px] bg-amber-300 rounded-sm`}
                ...
                return (
                  <div key={i} className="relative">
                    <button
                      ...
                      className="w-full flex items-center justify-between px-5 py-3 text-sm text-gray-800 hover:bg-yellow-50 hover:text-yellow-600 border-b border-gray-100 transition"
                    >
                      <span>{cat}</span>
                      {hasSub &&
                        (isExpanded ? (
                        ...
                        {data.subCategories[cat].map(
                          (sub: string, j: number) => (
                            <Link
                              ...
                              className="block px-4 py-2 text-sm text-gray-700 hover:bg-yellow-100 hover:text-yellow-600"
